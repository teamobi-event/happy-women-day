...
function anim() {
  ...
  if (!isRepeat && !isShowBox) {
    ...
    isShowBox = true;
    isTrans = true;
    mFirefly.removeAttribute("hidden");
    // var myHeart = document.querySelector("#canvas");
    // myHeart.style.position = "absolute";
    // myHeart.style.top = "0px";
    // myHeart.style.left = "0px";
    box3d.removeAttribute("hidden");
    mFirefly.style.top = "0px";
    mFirefly.style.left = "0px";
    percentTrans = 0;
  }
